class SalesController < ApplicationController
  ...
  def create
    ...
    if @sale.client_id.nil?
      ...
      @sale.client.linkedin = client.linkedin
    end

  #  puts "Datos recibidos de la nueva venta"
  #  @sale.client.nombre = client.nombre ##si el cliente ya existe, se actualiza al nuevo valor recibido
  #  puts "cliente>> " + @sale.client_id.to_s + @sale.client.nombre.to_s
  ...
  private
    ...
    def sale_params
      params.require(:sale).permit(:client_id, :fecha, :importe)
    end

    def client_params
      params.require(:client).permit(:nombre, :direccion, :telefono, :email, :facebook, :linkedin)
    end
